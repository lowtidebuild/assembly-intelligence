 ...
 *
 * Each preset is intentionally thin: include keywords + exclude
 * keywords + suggested committees + LLM context. No legislator lists — those are picked by the user
...
export interface IndustryPreset {
  ...
  keywords: string[];
  /** Phrases that should suppress false positives from broad keywords */
...
국가사이버안보센터.
    `.trim(),
    presetVersion: "cybersecurity-v1.1",
  },
